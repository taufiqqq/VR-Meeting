...
namespace Whisper.Samples
{
    ...
    public class AudioClipDemo : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            languageDropdown.value = languageDropdown.options.FindIndex(op => op.text == manager.language);
        ...
        public void OnLanguageChanged(int ind)
        {
            var opt = languageDropdown.options[ind];
            manager.language = opt.text;
        }
        
        public void OnTranslateChanged(bool translate)
        {
